...
describe "handle_event" do
  ...
  it "should log any problem parsing JSON" do
    expect($logger).to receive(:error).with('problem parsing JSON for event', mockMessage)
  ...
  it "should log any error from saving record" do
    expect($logger).to receive(:error).with('problem persisting records to database', mockMessage)
  ...
  it "should push record to kinesis" do
    ...
    expect($kinesis_client).to receive(:<<).with(
      {"id"=>1140039, "bib_ids"=>[17058685], "bib_id_links"=>["https://nypl-sierra-test.nypl.org/iii/sierra-api/v6/bibs/17058685"], "item_ids"=>[], "item_id_links"=>[], "inherit_location"=>false, "allocation_rule"=>nil, "accounting_unit"=>1, "label_code"=>"n", "serial_code_1"=>"a", "serial_code_2"=>"-", "serial_code_3"=>"-", "serial_code_4"=>"-", "claim_on_date"=>"2020-06-07T04:00:00Z", "receiving_location_code"=>"16", "vendor_code"=>"none", "update_count"=>"-", "piece_count"=>0, "e_check_in_code"=>" ", "media_type_code"=>" ", "updated_date"=>"2020-03-23T13:22:02Z", "created_date"=>"2020-03-23T13:14:50Z", "deleted_date"=>nil, "deleted"=>false, "suppressed"=>false, "fixed_fields"=>{"35"=>{"label"=>"Label Type", "value"=>"n", "display"=>nil}, "36"=>{"label"=>"Serial Code 1", "value"=>"a", "display"=>nil}, "37"=>{"label"=>"Serial Code 2", "value"=>"-", "display"=>nil}, "38"=>{"label"=>"Copies", "value"=>"1", "display"=>nil}, "39"=>{"label"=>"Claim On", "value"=>"2020-06-07", "display"=>nil}, "40"=>{"label"=>"Location", "value"=>"mak  ", "display"=>nil}, "41"=>{"label"=>"Recv Location", "value"=>"16 ", "display"=>nil}, "42"=>{"label"=>"Vendor", "value"=>"none ", "display"=>nil}, "80"=>{"label"=>"Record Type", "value"=>"c", "display"=>nil}, "81"=>{"label"=>"Record Number", "value"=>"1140039", "display"=>nil}, "83"=>{"label"=>"Created Date", "value"=>"2020-03-23T13:14:50Z", "display"=>nil}, "84"=>{"label"=>"Updated Date", "value"=>"2020-03-23T13:22:02Z", "display"=>nil}, "85"=>{"label"=>"No. of Revisions", "value"=>"2", "display"=>nil}, "86"=>{"label"=>"Agency", "value"=>"1", "display"=>nil}, "98"=>{"label"=>"PDATE", "value"=>"2020-03-23T13:14:00Z", "display"=>nil}, "118"=>{"label"=>"Serial Code 3", "value"=>"-", "display"=>nil}, "119"=>{"label"=>"Serial Code 4", "value"=>"-", "display"=>nil}, "120"=>{"label"=>"Update Count", "value"=>"-", "display"=>nil}, "121"=>{"label"=>"Piece Count", "value"=>"0", "display"=>nil}, "137"=>{"label"=>"E-Checkin", "value"=>" ", "display"=>nil}, "159"=>{"label"=>"Media Type", "value"=>" ", "display"=>nil}, "266"=>{"label"=>"Inherit Location", "value"=>"false", "display"=>nil}}, "var_fields"=>[{"fieldTag"=>"_", "marcTag"=>nil, "ind1"=>nil, "ind2"=>nil, "content"=>"00000ny   22000003n 4500", "subfields"=>nil}, {"fieldTag"=>"h", "marcTag"=>"863", "ind1"=>" ", "ind2"=>" ", "content"=>nil, "subfields"=>[{"tag"=>"8", "content"=>"1.1"}, {"tag"=>"a", "content"=>"1-3"}, {"tag"=>"i", "content"=>"2020"}, {"tag"=>"j", "content"=>"01-03"}, {"tag"=>"k", "content"=>"15"}]}, {"fieldTag"=>"i", "marcTag"=>nil, "ind1"=>nil, "ind2"=>nil, "content"=>"TEST IDENTITY", "subfields"=>nil}, {"fieldTag"=>"n", "marcTag"=>nil, "ind1"=>nil, "ind2"=>nil, "content"=>"Public note", "subfields"=>nil}, {"fieldTag"=>"y", "marcTag"=>"853", "ind1"=>" ", "ind2"=>" ", "content"=>nil, "subfields"=>[{"tag"=>"8", "content"=>"1"}, {"tag"=>"a", "content"=>"no."}, {"tag"=>"i", "content"=>"(year)"}, {"tag"=>"j", "content"=>"(month)"}, {"tag"=>"k", "content"=>"(day)"}]}, {"fieldTag"=>"z", "marcTag"=>nil, "ind1"=>nil, "ind2"=>nil, "content"=>"INTERNAL NOTE", "subfields"=>nil}], "location"=>{"code"=>"mak", "label"=>"Schwarzman Building - Dewitt Wallace Room 108"}, "holdings"=>[]}
    )
